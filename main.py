...
#    os.system('clear')
    ...
    for turn in range(g.num_turns):
        ...
        if turn >=1 :
            ...
            print('beliefstate BEFORE Q:', belief_state)
            Q = believer.rollout(g,belief_state,hit,miss,gamma,Rhit,Rmiss)
            print('beliefstate AFTER Q:', Q)

            belief_state = believer.convert2beliefstate(g,Q,hit,miss)
            print('beliefstate AFTER CONVERSION:',belief_state)
